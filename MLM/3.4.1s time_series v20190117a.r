...
# In this exercise, we will use a data set from forecast library:
# Australian total wine sales in bottle <= 1 litre from 1/1980 to 8/1994 by 
# month.
data(wineind)
str(wineind)
wineind

wrkng.path <- 'C:/Users/mparadis/Desktop/DSU/Immersion College/02 MLM/03. Supervised Regression/3.4 Time Series Regression/Example Scripts/'
...
adf.test( # Augmented Dickey-Fuller Test
  ...
  k = trunc((length(wineind)-1)^(1/3)) # Lag Order
  )
