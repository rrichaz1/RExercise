...
#########################################################################
## Dimenionsionality reduction with PCA  & LDA
#########################################################################
...
#####################################################################################
#LDA on all data  components
#####################################################################################


appeal.lda = lda(formula = success ~ .,
                data = appeal_scaled_df )
summary(appeal.lda)
appeal.lda

plot(appeal.lda, type="both")
##################################################
# On some runs gave collinearity warning
########################################################################
...
###########################################################################
###Using caret package for feature selection  --- pretty resource intensive
###########################################################################
...
#predicted <-predict(model.full, appeal_scaled_df[3:297,],type="response")
#predicted
